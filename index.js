...
app.get('/', (req, res) => res.send(`<html><head><meta name="tiktok-developers-site-verification" content="W5NcrSJ3TOG8cCjLHQXmihN6aBppukkB" /></head><body><h1>Little Legs Bot</h1></body></html>`));
...
app.get('/tiktokW5NcrSJ3TOG8cCjLHQXmihN6aBppukkB.txt', (req, res) => res.send('tiktok-developers-site-verification=W5NcrSJ3TOG8cCjLHQXmihN6aBppukkB'));
